...
Source0  : https://download.gnome.org/sources/gnome-session/3.28/gnome-session-3.28.0.tar.xz
...
%prep
%setup -q -n gnome-session-3.28.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1522197742
