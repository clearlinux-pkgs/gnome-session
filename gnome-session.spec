...
Version  : 48.0
Release  : 65
URL      : https://download.gnome.org/sources/gnome-session/48/gnome-session-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/48/gnome-session-48.0.tar.xz
...
%prep
%setup -q -n gnome-session-48.0
cd %{_builddir}/gnome-session-48.0
%patch -P 1 -p1
pushd ..
cp -a gnome-session-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744645311
...
%files locales -f gnome-session-48.lang
%defattr(-,root,root,-)
