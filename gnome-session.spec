...
Version  : 3.33.92
Release  : 29
URL      : https://download.gnome.org/sources/gnome-session/3.33/gnome-session-3.33.92.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/3.33/gnome-session-3.33.92.tar.xz
...
%prep
%setup -q -n gnome-session-3.33.92
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568122959
...
/usr/lib/systemd/user/gnome-session-stable.target
/usr/lib/systemd/user/gnome-session-stable.timer
