...
Source0  : https://download.gnome.org/sources/gnome-session/3.38/gnome-session-3.38.0.tar.xz
...
%prep
%setup -q -n gnome-session-3.38.0
cd %{_builddir}/gnome-session-3.38.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600297238
...
cp %{_builddir}/gnome-session-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-session/4cc77b90af91e615a64ae04893fdffa7939db84c
