...
Version  : 3.30.1
Release  : 22
URL      : https://download.gnome.org/sources/gnome-session/3.30/gnome-session-3.30.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/3.30/gnome-session-3.30.1.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: gnome-session-bin
Requires: gnome-session-data
Requires: gnome-session-license
Requires: gnome-session-locales
Requires: gnome-session-man
...
%prep
%setup -q -n gnome-session-3.30.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537924119
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/gnome-session
cp COPYING %{buildroot}/usr/share/doc/gnome-session/COPYING
