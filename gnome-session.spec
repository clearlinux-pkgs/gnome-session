...
Version  : 3.34.1
Release  : 32
URL      : https://download.gnome.org/sources/gnome-session/3.34/gnome-session-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/3.34/gnome-session-3.34.1.tar.xz
...
%prep
%setup -q -n gnome-session-3.34.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570460698
