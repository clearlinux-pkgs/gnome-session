...
Source0  : https://download.gnome.org/sources/gnome-session/40/gnome-session-40.1.1.tar.xz
...
%prep
%setup -q -n gnome-session-40.1.1
cd %{_builddir}/gnome-session-40.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622762753
...
cp %{_builddir}/gnome-session-40.1.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-session/4cc77b90af91e615a64ae04893fdffa7939db84c
