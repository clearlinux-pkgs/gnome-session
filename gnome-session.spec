...
Version  : 3.26.0
Release  : 12
URL      : https://download.gnome.org/sources/gnome-session/3.26/gnome-session-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/3.26/gnome-session-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-session-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1505325166
