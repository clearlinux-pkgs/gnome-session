...
Source0  : https://download.gnome.org/sources/gnome-session/40/gnome-session-40.0.tar.xz
...
%prep
%setup -q -n gnome-session-40.0
cd %{_builddir}/gnome-session-40.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619114506
...
cp %{_builddir}/gnome-session-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-session/4cc77b90af91e615a64ae04893fdffa7939db84c
DESTDIR=%{buildroot} ninja -C builddir install
%find_lang gnome-session-40
...
%files locales -f gnome-session-40.lang
%defattr(-,root,root,-)
