...
Version  : 47.0.1
Release  : 64
URL      : https://download.gnome.org/sources/gnome-session/47/gnome-session-47.0.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-session/47/gnome-session-47.0.1.tar.xz
...
%prep
%setup -q -n gnome-session-47.0.1
cd %{_builddir}/gnome-session-47.0.1
%patch -P 1 -p1
pushd ..
cp -a gnome-session-47.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726766417
...
%files locales -f gnome-session-47.lang
%defattr(-,root,root,-)
